...
- ✅ **Paleta de Cores Coesa** — Verde principal `#28a745` com tons complementares escuros
- ✅ **Animações Suaves** — Transições e efeitos de foco discretos para fluidez na navegação
- ✅ **Ícones Intuitivos** — Font Awesome em todos os campos e seções
...
| **JavaScript Vanilla** | Interações e animações leves |
| **Font Awesome 6.5.0** | Ícones modernos |
| **Google Fonts (Poppins)** | Tipografia elegante |
| **Formspree** | Processamento do formulário |
...
| Dispositivo | Layout |
|--------------|--------|
| **Desktop** (>768px) | Grid em 2 colunas |
| **Tablet** (481–768px) | Layout fluido |
